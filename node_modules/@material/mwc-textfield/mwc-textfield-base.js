...
import { html as y } from '../../lit-html/lit-html.js';
import '../../lit-element/lit-element.js';
import { property as e } from '../../@lit/reactive-element/decorators/property.js';
...
import { live as l$1 } from '../../lit-html/directives/live.js';
...
class TextFieldBase extends FormElement {
    ...
    renderInput(shouldRenderHelperText) {
      ...
      <input
          ...
          aria-controls="${l(ariaControlsOrUndef)}"
          aria-describedby="${l(ariaDescribedbyOrUndef)}"
          ...
          pattern="${l(this.pattern ? this.pattern : undefined)}"
          min="${l(this.min === '' ? undefined : this.min)}"
          max="${l(this.max === '' ? undefined : this.max)}"
          step="${l(this.step === null ? undefined : this.step)}"
          size="${l(this.size === null ? undefined : this.size)}"
    ...
    renderHelperText(shouldRenderHelperText, shouldRenderCharCounter) {
      ...
      <div class="mdc-text-field-helper-line">
        <div id="helper-text"
             aria-hidden="${l(ariaHiddenOrUndef)}"
